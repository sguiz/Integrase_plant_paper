...
tuning_data = pd.read_excel(r'path to tuning data file', sheet_name='your sheet name', usecols="B:H")
tuning_data_norm = pd.read_excel(r'path to normalized tuning data file', sheet_name='your sheet name', usecols="B:H")
LR_data_norm = pd.read_excel(r'path to T2 data file', sheet_name='your sheet name', usecols="B:F")
...
# choose file type
plot_data(LR_plot_info, ['L1_ARF19_4_T2P2_rd1','L1_ARF19_4_T2P3_rd1', 'L1_ARF19_4_T2P4_rd1', 'L1_ARF19_4_T2P12_rd1', 'L1_ARF19_4_T2P13_rd1','L1_ARF19_4_T2P14_rd1'], 110, "path where you want to save plot")
plot_data(tuning_plot_info, ['L1B1','L1B2', 'L1B6', 'L1B8', 'NC'], 115, "path where you want to save plot")
